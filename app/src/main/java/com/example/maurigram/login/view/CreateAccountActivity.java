...
import com.example.maurigram.login.presenter.CreateAccountPresenterImpl;
...
public class CreateAccountActivity extends AppCompatActivity implements CreateAccountView {
    ...
    private com.google.android.material.textfield.TextInputEditText edtEmail, edtName, edtUser, edtPassword, edtPasswordConfirm;
